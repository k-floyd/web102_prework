...
raisedCard.innerHTML = `
    <p>$${totalPledged.toLocaleString()}</p>
`;
...
//const unfundedGamesCount = GAMES_JSON.filter(game => game.pledged < games.goal).length;

// create a string that explains the number of unfunded games using the ternary operator
//const description = `A total of $${totalRaised} has been raised for ${GAMES_JSON.length} games. Currently, ${unfundedGamesCount === 0 ? "games are funded" : `${unfundedGamesCount} game${unfundedGamesCount === 1 ? "" : "s"} ${unfundedGamesCount === 1 ? "is" : "are"} still unfunded. We need your help to fund these amazing games!`}.`;
